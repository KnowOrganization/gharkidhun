...
// CHOREPLAY mood names, not claims about ownership of the linked playlists.
...
export const rooms: Room[] = [
  { id: 'living-room', name: 'Living Room', number: '01', image: 'living-room', headline: 'Playlists for a cleaner living room.', description: 'For every jhaadu, pocha, and dusting session.', defaultChore: 'pocha', mobileImage: 'living-room-mobile', cover: 0, mobileEffects: [], effects: [], chores: [
    { id: 'jhadu', label: 'Jhadu', description: 'A familiar tune for every corner of home.', title: 'Jhadu Jukebox', tagline: 'A clean sweep. A classic beat.', playlist: 'classics', anchor: { x: 17.5, y: 54 }, mobileAnchor: { x: 10, y: 55 } },
    { id: 'pocha', label: 'Pocha', description: 'A little rhythm for your Sunday reset.', title: 'Pocha Afterparty', tagline: 'Clean floors. Dirty basslines.', playlist: 'butter', anchor: { x: 81, y: 63.5 }, mobileAnchor: { x: 78, y: 63 } },
    { id: 'dusting', label: 'Dusting', description: 'Old favourites. A fresh little beginning.', title: 'Dust & Disco', tagline: 'Less dust. More dancing.', playlist: 'gold', anchor: { x: 90.2, y: 43.5 }, mobileAnchor: { x: 92, y: 42 } },
  ] },
  { id: 'kitchen', name: 'Kitchen', number: '02', image: 'kitchen', headline: 'Playlists for your kitchen era.', description: 'Because every bartan baddie deserves a soundtrack', defaultChore: 'bartan', mobileImage: 'kitchen-mobile', cover: 1, mobileEffects: [{ kind: 'steam', x: 70, y: 40, width: 11, height: 6 }], effects: [
    ...
    { id: 'bartan', label: 'Bartan', description: 'A little Bollywood for the after-dinner dishes.', title: 'Bartan & Bollywood', tagline: 'Big choruses. One sinkful.', playlist: 'butter', anchor: { x: 55.5, y: 48 }, mobileAnchor: { x: 30, y: 47 } },
    { id: 'cooking', label: 'Cooking', description: 'Let the good tunes simmer.', title: 'Kitchen Mehfil', tagline: 'Made with love. And a little music.', playlist: 'gold', anchor: { x: 84, y: 46 }, mobileAnchor: { x: 75, y: 47 } },
    { id: 'counter-clean', label: 'Counter clean', description: 'One last wipe. One more favourite.', title: 'Counter Culture', tagline: 'A quick clean, a good groove.', playlist: 'classics', anchor: { x: 77, y: 59 }, mobileAnchor: { x: 88, y: 57 } },
  ] },
  { id: 'washroom', name: 'Washroom', number: '03', image: 'washroom', headline: 'Playlists for the ultimate bathroom break.', description: 'For every scrub, shower, and sing-along.', defaultChore: 'basin-clean', mobileImage: 'washroom-mobile', cover: 2, mobileEffects: [{ kind: 'water', x: 26.3, y: 43.4, width: .7, height: 3.5 }, { kind: 'shower', x: 68, y: 23, width: 6, height: 35 }], effects: [
    ...
    { id: 'basin-clean', label: 'Basin clean', description: 'Big sing-alongs for the little clean-ups.', title: 'Scrub & Sing', tagline: 'For your bathroom encore.', playlist: 'classics', anchor: { x: 42, y: 51 }, mobileAnchor: { x: 30, y: 48 } },
    { id: 'shower-scrub', label: 'Shower scrub', description: 'Your bathroom is the concert hall.', title: 'Shower Superstar', tagline: 'Every scrub deserves a solo.', playlist: 'butter', anchor: { x: 72, y: 42 }, mobileAnchor: { x: 76, y: 41 } },
    { id: 'floor-clean', label: 'Floor clean', description: 'Good tunes for the finishing touches.', title: 'Shiny Happy Floors', tagline: 'Make room for a brighter mood.', playlist: 'gold', anchor: { x: 78, y: 75 }, mobileAnchor: { x: 81, y: 63 } },
  ] },
  ...
  { id: 'utility', name: 'Utility Room', number: '05', image: 'utility', headline: 'Playlists for your laundry pile.', description: 'Because it’s not folding itself.', defaultChore: 'laundry', mobileImage: 'utility-mobile', cover: 4, mobileEffects: [], effects: [], chores: [
    { id: 'laundry', label: 'Laundry', description: 'A fresh load. A familiar chorus. A little time for you.', title: 'Spin & Sing', tagline: 'Good tunes, on a gentle cycle.', playlist: 'butter', anchor: { x: 58.5, y: 59 }, mobileAnchor: { x: 48, y: 53 } },
    { id: 'iron-clothes', label: 'Iron clothes', description: 'For the slow Sunday ritual of freshly pressed clothes.', title: 'Pressed & Play', tagline: 'A little steam. A lot of soul.', playlist: 'gold', anchor: { x: 90, y: 52 }, mobileAnchor: { x: 89, y: 49 } },
  ] },
];
